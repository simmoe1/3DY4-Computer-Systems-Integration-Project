...
def fmPll(pllIn, freq, Fs, Integrator, phaseEst,feedbackI, feedbackQ, trigOffset, ncoOut, ncoScale = 1.0, phaseAdjust = 0.0, normBandwidth = 0.01):
    ...
    return ncoOut, integrator, phaseEst, feedbackI, feedbackQ, trigOffset + len(pllIn)
